...
public class SimplePascalParser extends Parser {
	...
	public static final int
		...
		CCONST=34, RELOP=35, ADDOP=36, OROP=37, MULDIVANDOP=38, NOTOP=39, INOP=40, 
		STRING=41, LPAREN=42, RPAREN=43, SEMI=44, COMMA=45, EQU=46, COLON=47, 
		LBRACK=48, RBRACK=49, ASSIGN=50, DOT=51, DOTDOT=52, ID=53, COMMENT=54, 
		WHITESPACE=55, END_EOF=56;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CCONST", "RELOP", "ADDOP", "OROP", "MULDIVANDOP", "NOTOP", "INOP", "STRING", 
	...
	public final ConstantContext constant() throws RecognitionException {
		...
		try {
			...
			setState(193);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RCONST) | (1L << ICONST) | (1L << BCONST) | (1L << CCONST))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
