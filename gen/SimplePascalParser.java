...
public class SimplePascalParser extends Parser {
	...
	public static class LmtnegConstContext extends LimitContext {
		public TerminalNode ICONST() { return getToken(SimplePascalParser.ICONST, 0); }
		public TerminalNode SUBOP() { return getToken(SimplePascalParser.SUBOP, 0); }
		public LmtnegConstContext(LimitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).enterLmtnegConst(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).exitLmtnegConst(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimplePascalVisitor ) return ((SimplePascalVisitor<? extends T>)visitor).visitLmtnegConst(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LmtIdContext extends LimitContext {
		public TerminalNode ID() { return getToken(SimplePascalParser.ID, 0); }
		public TerminalNode SUBOP() { return getToken(SimplePascalParser.SUBOP, 0); }
		public LmtIdContext(LimitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).enterLmtId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).exitLmtId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimplePascalVisitor ) return ((SimplePascalVisitor<? extends T>)visitor).visitLmtId(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LmtConstContext extends LimitContext {
		public ConstantContext constant() {
			return getRuleContext(ConstantContext.class,0);
		}
		public LmtConstContext(LimitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).enterLmtConst(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimplePascalListener ) ((SimplePascalListener)listener).exitLmtConst(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimplePascalVisitor ) return ((SimplePascalVisitor<? extends T>)visitor).visitLmtConst(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final LimitContext limit() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new LmtnegConstContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(284);
				_errHandler.sync(this);
				...
				break;
			case 2:
				_localctx = new LmtConstContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(287);
				constant();
				...
				break;
			case 3:
				_localctx = new LmtIdContext(_localctx);
				enterOuterAlt(_localctx, 3);
				{
				setState(289);
				_errHandler.sync(this);
